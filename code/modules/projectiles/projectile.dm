...
/obj/item/projectile/proc/attack_mob(var/mob/living/target_mob, var/distance, var/miss_modifier=0)
	...
	if(silenced)
		...
		target_mob.visible_message(
			"<span class='danger'>\The [target_mob] is hit by \the [src] in the [parse_zone(def_zone)]!</span>",
			"<span class='danger'>You've been hit in the [parse_zone(def_zone)] by \the [src]!</span>"
